...
<nav className="bg-primary-main fixed w-full z-20 top-0 start-0 ">
  ...
  <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" className="text-primary-main
      
      bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-100 font-medium rounded-full text-sm px-4 py-2 text-center">Let's Talk</button>
