...
<section className="bg-center bg-cover bg-no-repeat bg-[url('/assets/confidence.jpeg')] bg-gray-700 bg-blend-multiply">
    <div className="relative h-screen text-center py-24 lg:py-56">
        ...
        <div className="text-left pl-5 md:pl-10">
            <Link href="#" className="bg-primary-main inline-flex justify-center hover:text-gray-200 items-center py-3 px-5 sm:ms-4 text-base font-medium text-center text-white rounded-full hover:bg-primary-active focus:ring-4 focus:ring-gray-400">
                View project
            </Link>  
        </div>
        </div>
